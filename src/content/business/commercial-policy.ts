...
const entries: KnowledgeEntryInput[] = [
  ...
  },
  {
    ...
    approvedAnswerPoints: ["Va por reparto, no por salario fijo.", "Si preguntas por la cifra exacta: 70% para Rose Models y 30% para ti.", "Se calcula sobre el neto despues de la comision de la plataforma."],
    prohibitedClaims: ["Mencionar el porcentaje de forma proactiva.", "Negociar un porcentaje por chat.", "Ofrecer 65/35 o 60/40 por chat.", "Prometer ingresos garantizados."],
    allowedStates: ["NEW_LEAD", "QUALIFYING", "APPROVED", "COLLECTING_CALL_DETAILS"],
    tags: ["percentage", "revenue-share"],
    mandatoryNuances: ["No mencionar porcentajes si la candidata no pregunta.", "No negociar por chat.", "No dar explicaciones largas."],
    escalationConditions: ["La candidata pide excepciones.", "La candidata negocia un porcentaje.", "La candidata pide condiciones fuera de la politica."],
    requiresHumanReview: false,
    version: "commercial-revenue-share-general-2026-06-09.2",
    status: "ACTIVE",
    approvedByAlex: true,
    updatedAt: "2026-06-08"
  },
  {
    ...
    facts: ["La liquidacion se realiza cada 14 dias desde la primera fecha en que la cuenta genera ingresos.", "La modelo recibe el dinero de la plataforma.", "La modelo paga a Rose Models mediante Skrill.", "Alex calcula manualmente cada liquidacion."],
    approvedAnswerPoints: ["La liquidacion va cada 14 dias desde que la cuenta genera ingresos.", "La plataforma te paga a ti y despues se paga a Rose Models por Skrill.", "Alex calcula cada liquidacion manualmente."],
    prohibitedClaims: ["Prometer automatizacion de pagos.", "Pedir datos de pago sensibles por chat inicial.", "Prometer una fecha exacta de ingresos."],
    allowedStates: ["NEW_LEAD", "QUALIFYING", "APPROVED", "COLLECTING_CALL_DETAILS"],
  ...
  },
  {
    ...
    facts: ["Rose Models gestiona creacion y crecimiento de cuentas, trafico, contenido publicado, chatting, monetizacion, estrategia y gestion operativa."],
    approvedAnswerPoints: ["Porque Rose Models se encarga de la parte operativa: cuentas, trafico, publicacion, chatting, monetizacion y estrategia."],
  ...
  },
  {
    ...
    category: "COMMERCIAL",
    title: "Impagos",
    facts: ["Alex comunica manualmente el importe.", "Si no paga, recibe un recordatorio.", "Tiene siete dias adicionales.", "Si continua sin pagar, se suspende el servicio.", "Puede finalizarse la relacion y reclamarse la deuda.", "El impago no concede uso ilimitado del contenido."],
    approvedAnswerPoints: ["Si hubiera un impago, primero se recuerda y hay siete dias adicionales antes de suspender el servicio.", "El impago no da derecho a uso ilimitado del contenido."],
