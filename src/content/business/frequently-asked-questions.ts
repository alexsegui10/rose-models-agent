...
const entries: KnowledgeEntryInput[] = [
  {
    ...
    facts: ["Rose Models valora primero el perfil, recopila informacion basica y despues puede organizar una llamada para explicar los detalles."],
    approvedAnswerPoints: ["Primero valoramos un poco el perfil.", "Si vemos que encaja, organizamos una llamada y lo explicamos con calma."],
    ...
    version: "faq-how-it-works-2026-06-08.1",
    status: "ACTIVE",
    approvedByAlex: true,
