...
import { followUpAttemptCountRange } from "@/application/policyRules";
...
const entries: KnowledgeEntryInput[] = [
  {
    ...
    facts: ["Si deja de responder, se envia un seguimiento cada uno o dos dias.", "Se realizan entre dos y tres intentos.", "No se envian mensajes indefinidamente.", "Si dice que no le interesa, se intenta recuperar una sola vez y si mantiene rechazo se cierra."],
    approvedAnswerPoints: ["Si no responde, se puede hacer seguimiento limitado, no insistir indefinidamente."],
    prohibitedClaims: ["Enviar mensajes indefinidos.", "Insistir despues de rechazo mantenido.", "Dar explicaciones fisicas de rechazo."],
