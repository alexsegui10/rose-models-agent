...
const entries: KnowledgeEntryInput[] = [
  {
    ...
    approvedAnswerPoints: ["Podemos hacer una llamada por WhatsApp si vemos que encaja.", "Suele ser corta, unos 2 a 10 minutos, para resolver dudas y explicarlo bien."],
    prohibitedClaims: ["Prometer llamada inmediata.", "Recoger documentacion durante la llamada.", "Automatizar envio de contrato."],
    ...
    version: "call-details-after-review-2026-06-09.2",
    status: "ACTIVE",
    approvedByAlex: true,
  ...
  },
  {
    ...
    facts: ["Retell debe informar al principio de que la llamada sera grabada y transcrita, explicar finalidad y solicitar aceptacion.", "Si no acepta, se finaliza educadamente la llamada.", "Debe registrarse fecha, hora, aceptacion, grabacion y transcripcion."],
  ...
  },
  {
    ...
    prohibitedClaims: ["Dejar al chatbot completar incorporacion despues de llamada.", "Omitir grabacion o transcripcion cuando existan."],
