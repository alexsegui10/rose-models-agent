...
const entries: KnowledgeEntryInput[] = [
  {
    ...
    facts: ["Las preguntas legales o contractuales no se resuelven en el chat inicial.", "Despues de la llamada Alex verifica identidad y mayoria de edad personalmente.", "Alex envia el contrato, gestiona documentacion, crea carpetas de Drive, explica referencias y completa la incorporacion manualmente."],
    approvedAnswerPoints: ["Esa parte prefiero comentarla con mi socio para darte la informacion correcta."],
    prohibitedClaims: ["Inventar clausulas contractuales.", "Negociar contratos por chat.", "Dar asesoramiento legal.", "Automatizar verificacion de identidad.", "Automatizar envio de contrato."],
  ...
  },
  {
    ...
    facts: ["Existe un preaviso previsto de un mes.", "La intencion actual ante abandono sin preaviso es poder usar durante un mes adicional solo contenido previamente autorizado.", "Despues de ese mes debe dejar de utilizarse salvo autorizacion contractual diferente."],
    approvedAnswerPoints: ["Esta parte esta pendiente de revision legal y la explicaria Alex en el contrato."],
    prohibitedClaims: ["Presentarlo como clausula definitiva.", "Afirmar uso ilimitado de contenido.", "Dar asesoramiento legal."],
