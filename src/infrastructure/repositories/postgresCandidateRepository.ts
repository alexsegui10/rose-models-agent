...
function rowToCandidate(row: CandidateRow): Candidate {
  return normalizeCandidate({
    ...
    callTimePreference: row.callTimePreference ?? undefined,
    adId: row.adId ?? undefined,
    adTitle: row.adTitle ?? undefined,
    adReferralJson: row.adReferralJson ?? undefined,
    callAttempts: row.callAttempts,
    lastCall: row.lastCall ?? undefined,
    lastCallConversationId: row.lastCallConversationId ?? undefined,
...
function candidateToRow(candidate: Candidate): CandidateInsert {
  return {
    ...
    callTimePreference: candidate.callTimePreference ?? null,
    adId: candidate.adId ?? null,
    adTitle: candidate.adTitle ?? null,
    adReferralJson: candidate.adReferralJson ?? null,
    callAttempts: candidate.callAttempts,
    lastCall: candidate.lastCall ?? null,
    lastCallConversationId: candidate.lastCallConversationId ?? null,
    pendingInbound: candidate.pendingInbound,
